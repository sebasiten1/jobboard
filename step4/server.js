...
var cookieSession = require('cookie-session') //coukie de session (permet a l'utilisateur de rester connecter apret une déconnexion)
...
require("./routes/clients/delete.js")(app, con, logger);
require("./routes/clients/connexion.js")(app, con, bcrypt, salt, logger, jwt, secret);

//Routes entreprise
require("./routes/entreprises/get.js")(app, con, logger, jwt, secret);
