...
app.post('/adds/create',function (req,res){
  ...
  var verif = annonceCreated(form_annonce.email, form_annonce.location, form_annonce.description, form_annonce.content, form_annonce.title, form_annonce.contrat_type, form_annonce.contrat_time_beg, form_annonce.contrat_time_end);
